...
from paraphrase_strategies.bert_sampling_utils_lm import get_lm
from paraphrase_strategies.bert_sampling_utils_text_parser import TextParser
from paraphrase_strategies.bert_sampling_utils_wpe import get_wordpiece_emb
...
class BertSamplingStrategy(StrategyBase):
    ...
    __hyperparameters__ = [
        ...
        ("burnin_steps", int, 50, "number of burnin steps."),
        ("sampling_steps", int, 100, "number of sampling steps (including) burnin."),
    ...
    def paraphrase_example(self, data_record, field_name, n):
        ...
        clipped_text = " ".join(data_record[field_name].split()[:200]) #200
        ...
        if self._stats["accept"] / self._stats["all"] * 100 < 30:
            logger.info("Aggregated accept rate is less than 30%.")
